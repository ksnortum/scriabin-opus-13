# scriabin-opus-13
[LilyPond](https://lilypond.org/) engraving source files used to create Scriabin's Six Preludes, opus 13.
...
The PDF and MIDI files can be created by issuing the following command in the directory this file is in (assuming you have `lilypond` in your PATH variable):
        ...
        lilypond preludes-op13-book.ly

To create a smaller PDF, try:

        lilypond -dno-point-and-click preludes-op13-book.ly

You may also [download the latest release](https://github.com/ksnortum/scriabin-opus-13/releases/latest) to get the compiled PDF and MIDI files.
